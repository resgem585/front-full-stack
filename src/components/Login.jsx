...
{/* <div className="css-175oi2r" style={{alignItems: 'stretch', backgroundColor: 'rgba(221, 221, 221, 0.06)', borderRadius: 8, flexDirection: 'column', justifyContent: 'center', padding: 48, width: '837.333px'}}>
